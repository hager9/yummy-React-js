...
export default function Contact() {
  ...
  const validationSchema = Yup.object({
    ...
    age: Yup.number()
      .min(14, "your age must be at least 14")
      .max(95, "maxmum age is 95")
      .required("age is required"),
    password: Yup.string()
      .matches(
        /^[A-Z][A-Za-z0-9]{5,8}/,
        "password should start with uppercase letter & only contain letters (A-Z or a-z) and numbers (0-9) & be between 6 and 9 characters in total."
      )
      .required("password is required")
      .min(6)
      .max(9),
    rePassword: Yup.string()
      .oneOf([Yup.ref("password")], "rePassword don't match the password")
          ...
          <div className="contact d-flex justify-content-center align-items-center min-vh-100">
            <div className="container text-center">
              ...
              <button
                ...
                type="submit"
                className="btn btn-outline-danger px-2 my-3"
              >
                Submit
              </button>
            </div>
